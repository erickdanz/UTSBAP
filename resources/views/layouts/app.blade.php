    ...
    <main id="main">
        ...
        <section id="resume" class="resume">
            <div class="container" data-aos="fade-up">
                <?php 
                $biodata = \DB::select('SELECT Nama, JenisKelamin, TanggalLahir, StudentID, kode_term FROM mahasiswaerick');    
                ?>
                <br>
                ...
                <div class="row" style="margin-left: 250px; margin-right: 250px; background-color:#eeeeee">
                    @yield('content')
                </div>
